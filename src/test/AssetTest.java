...
public class AssetTest {
    ...
    public void test3IsHealthy() {
        cattle1.setDead();
        cattle2.setDiseased();
        assertTrue(!cattle1.isHealthy() && !cattle2.isHealthy() && corn1.isHealthy());
    }
    ...
    public void test8AssetTypeToString() {
        assertTrue(sheep1.getTypeName().equalsIgnoreCase("Sheep") &&
                cow1.getTypeName().equalsIgnoreCase("Dairy Cow") &&
                hog1.getTypeName().equalsIgnoreCase("Hog") &&
                cattle1.getTypeName().equalsIgnoreCase("Cattle") &&
                corn1.getTypeName().equalsIgnoreCase("Corn") &&
                soy1.getTypeName().equalsIgnoreCase("Soy"));
    }
